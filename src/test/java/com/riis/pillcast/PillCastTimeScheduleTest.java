...
public class PillCastTimeScheduleTest {
	...
	@Test
	public void test1_TimeScheduleUpdateSuccess()throws Exception {
	...
	@Test
	public void test2_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test3_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test4_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test5_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test6_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test7_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
	...
	@Test
	public void test8_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
		String body = IOUtils.toString(new FileInputStream(new File("src/main/resources/timeschedule7.json")), StandardCharsets.UTF_8);
		Header header = new Header("Authorization", "Bearer " + token);
	...
	@Test
	public void test9_TimeScheduleUpdateSuccess()throws Exception {
		token = Authenticator.getIdToken();
		System.out.println(token);
